...
---
# Avaliação de Impacto {#avaliacaoimpacto}
...
## Percepções com base qualitativa {#impactquali}
...
Por fim, a Figura \@ref(fig:mixword) exibe um conjunto de palavras-chave que representam as discussões abordadas pela equipe de Protagonismo nos dois anos do Projeto. Um glossário de novos vocábulos foi construído pelas estudantes sob orientação da equipe do projeto (ver Apêndice \@ref(glossario)).
...
knitr::include_graphics(c("images/image124.png","images/image36.png","images/image37.png","images/image38.png"))
```
...
## Percepção com base quantitativa {#impactquant}
