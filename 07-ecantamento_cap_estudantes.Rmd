# Encontros virtuais com estudantes bolsistas
...
```{r meetenctprot, fig.cap='Registro de um dos encontros com a equipe de Protagonismo.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("images/image125.png")
```


```{r meetenctsite, fig.cap='Registro de um dos encontros com a equipe do site (re)Conhecendo Salvador.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("images/image126.png")
```


## Produção de Podcasts: Mulheres Extraordinárias
...
```{r podcast, fig.cap='Podcast Mulheres Extraordinárias publicado pelas estudantes no Spotify. A edição dos áudios e as publicações no Spotify são de responsabilidade da estudante do 9º ano do ensino fundamental Maíra Oliveira Esquerre (voluntária).', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("images/image95.png")
```


## Encantamento do público escolar
...
```{r exemplosvideo, fig.cap='Exemplos de vídeos compartilhados com as/os estudantes e professores.', echo=FALSE, message=FALSE, warning=FALSE}
...
```{r quadro5, echo=FALSE, message=FALSE, warning=FALSE}
